...
public class TestingClass {
    public static void main(String[] args) {
        ...
        // Note: both questions make use of the same object class,
        // but call different constructors based on what data they need to
        // pass.
        ...
        try {
            ...
            ChildString childObj = new ChildString(value, findMe);
            ...
            System.out.println("\nThere are " + childObj.count() +
                    " instances of the character '" + findMe + "' in the string!");
        ...
        try {
            ...
            ChildString childObj = new ChildString(value);
